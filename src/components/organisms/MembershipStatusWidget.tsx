  ...
  <div className="glass rounded-2xl border border-primary/20 p-5">
    <div className="flex items-center justify-between mb-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="font-bold">Membership {plan}</h3>
          <p className="text-xs text-muted-foreground">Member sejak {memberSince}</p>
        </div>
      </div>
    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between text-sm">
        <span className="text-muted-foreground">Masa berlaku membership</span>
        <span className="font-semibold">{daysLeft} hari tersisa</span>
      </div>
      ...
      <div className="flex items-center justify-between text-xs text-muted-foreground">
        <span>Hari ini</span>
        <span>Berakhir {validUntil}</span>
      </div>
    </div>

    <div className="mt-4 flex gap-2">
      <Button variant="hero" size="sm" className="flex-1" asChild>
        <Link href="/membership">Perpanjang Membership</Link>
      </Button>

...
import { Eye, EyeOff, Zap, User, Mail, Lock, Phone, CheckCircle } from "lucide-react";
        ...
        <div className="w-full max-w-md">
          ...
          {!done ? (
            ...
            <div className="text-center">
              ...
              <h2 className="text-3xl font-black mb-3">You&apos;re <span className="gradient-text">In!</span></h2>
              <p className="text-muted-foreground mb-2">Welcome to S-One Gym, <strong className="text-foreground">{form.name || "there"}</strong>!</p>
              <p className="text-sm text-muted-foreground mb-8">
                Akunmu sudah aktif. Pilih paket membership yang cocok untukmu kapan saja dari halaman Membership.
              </p>
              <Button variant="hero" size="lg" className="w-full" asChild>
                <Link href="/membership">Pilih Paket Membership <Zap size={18} /></Link>
              </Button>
              <Button variant="neon" size="lg" className="w-full mt-3" asChild>
                <Link href="/dashboard">Lewati, ke Dashboard</Link>
              </Button>
              <div className="mt-4 text-xs text-muted-foreground">
                Need help? Email us at <a href="mailto:hello@s-onegym.id" className="text-primary">hello@s-onegym.id</a>
              </div>
            </div>
          )}
        </div>
